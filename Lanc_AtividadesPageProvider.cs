...
namespace PROJETO.DataProviders
{
	...
	/// </summary>
	public class Lanc_AtividadesPageProvider : GeneralProvider
	{

		public Lanc_AtividadesPageProvider(IGeneralDataProvider Provider)
		{
			MainProvider = Provider;
			MainProvider.DataProvider = new _25246FASTRAX_TB_PARAMETRODataProvider(MainProvider, MainProvider.TableName, MainProvider.DatabaseName, "", "Lanc_Atividades");
